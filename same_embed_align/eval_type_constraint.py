...
if backend.lower() == 'mxnet':
    ...
    from train_pytorch import test, test_mp, test_rel_constrain
...
def main():
    ...
    if args.num_proc > 1:
        ...
        if args.sampler_type == 'both':
            test_rel_constrain(args, model, [test_sampler_head, test_sampler_tail])
        elif args.sampler_type == 'head':
            test_rel_constrain(args, model, [test_sampler_head])
        elif args.sampler_type == 'tail':
            test_rel_constrain(args, model, [test_sampler_tail])
