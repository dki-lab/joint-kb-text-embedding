...
cdef class Dictionary:
    ...
    def __reduce__(self):
        return (self.__class__, (self._word_dict, self._entity_dict, self._redirect_dict, self._word_stats, self._entity_stats, self.language, self.lowercase, self.build_params, self.min_paragraph_len, self.uuid))
